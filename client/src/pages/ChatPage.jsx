...
const ChatPage = () => {
    ...
    const fetchChats = async () => {
        try {
            ...
            // If there's an active selected chat, update it in place to get latest status
            if (selectedChat) {
    ...
    if (!user) {
        return (
            <div className="h-[calc(100vh-64px)] flex items-center justify-center text-slate-400 bg-slate-50 font-sans">
